            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <textarea id="discription_editor" name="product_discription" ></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">                            
                            <img style="width: 150px" id="product_img_load" src="" alt="">                            
                            <label for="product_img_select"><img style="width:100px; cursor:pointer;" src="{{ URL::to('frontend/assets/images/single.png') }}" alt=""></label>
                            <input style="display:none" id="product_img_select" name="photo" type="file" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="post-multi-imges"></div>                            
                            <label for="multi_img_select"><img style="width:100px; cursor:pointer;" src="{{ URL::to('frontend/assets/images/multipal.png') }}" alt=""></label>                          
                            <input style="display:none" name="multi_photo[]" type="file"  id="multi_img_select" class="form-control" multiple>
                        </div>
                    </div>
                </div> 
            </div>
